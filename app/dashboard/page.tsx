...
export default function DashboardPage() {
  ...
  // Get recent top documents (including ABC Traders, XYZ Supplies, OfficeMart)
  ...
  return (
    <div className="space-y-8 animate-fadeIn">
      ...
      {/* 3 Important Numbers Only (No unnecessary charts) */}
      ...
      <div className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200 shadow-sm flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
        ...
        <div className="flex flex-wrap sm:flex-nowrap items-center gap-3 shrink-0 w-full sm:w-auto">
          ...
          <Link
            ...
            className="w-full sm:w-auto px-4 py-3 bg-slate-100 hover:bg-slate-200 text-slate-700 text-sm font-medium rounded-xl transition-colors flex items-center justify-center gap-1.5"
          >
