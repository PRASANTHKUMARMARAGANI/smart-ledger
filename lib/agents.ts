...
export async function runMultiAgentPipeline(
  ...
  const newDocument: LedgerDocument = {
    ...
    vendorGstin: extraction.vendorGstin,
    ...
    billToCustomer: extraction.billToCustomer,
    billToAddress: extraction.billToAddress,
    billToGstin: extraction.billToGstin,
    subtotal: extraction.subtotal,
    taxGst: extraction.taxGst,
    taxLabel: extraction.taxLabel,
    totalAmount: extraction.totalAmount,
    calculatedTotal: extraction.calculatedTotal,
    amountInWords: extraction.amountInWords,
